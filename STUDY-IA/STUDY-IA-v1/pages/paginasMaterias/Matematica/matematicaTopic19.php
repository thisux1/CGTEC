...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['btn1'])) {
        $message = 'conteudoMatematica/topico19.html'; // Define o caminho do arquivo HTML
    } elseif (isset($_POST['btn2'])) {
        $message = ""; // URL do vídeo do YouTube
    } elseif (isset($_POST['btn3'])) {
        $message = 'conteudoMatematica/exercicios19.html'; // Exemplo de mensagem simples
    }
}
?>
...
<body>
    ...
    <div class="boxMeio">
        ...
        <br>
        <span class="topico">Funções Trigonométricas</span>
