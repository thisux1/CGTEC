...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['btn1'])) {
        $message = 'conteudosGeografia/topico14.html'; // Define o caminho do arquivo HTML
    } elseif (isset($_POST['btn2'])) {
        $message = ""; // URL do vídeo do YouTube
    } elseif (isset($_POST['btn3'])) {
        $message = 'conteudosGeografia/exercicios14.html'; // Exemplo de mensagem simples
    }
}
?>
...
<body>
    ...
    <div class="boxMeio">
        ...
        <span class="titulo">7. Meio Ambiente e Sustentabilidade</span>
        <br>
        <span class="topico">Sustentabilidade: desenvolvimento sustentável e energias renováveis</span>
