...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['btn1'])) {
        $message = 'conteudosQuimica/topico7.html'; // Define o caminho do arquivo HTML
    } elseif (isset($_POST['btn2'])) {
        $message = "https://www.youtube.com/embed/Vzt2BBjqcqQ?si=ehRgRjRI4E58TTd7"; // URL do vídeo do YouTube
    } elseif (isset($_POST['btn3'])) {
        $message = 'conteudosQuimica/exercicios7.html'; // Exemplo de mensagem simples
    }
}
?>
...
<body>
    ...
    <div class="boxMeio">
        ...
        <br>
        <span class="topico">Concentração (molaridade, título)</span>
