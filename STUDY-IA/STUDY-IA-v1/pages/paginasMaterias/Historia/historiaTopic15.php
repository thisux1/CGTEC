...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['btn1'])) {
        $message = 'conteudosHistoria/topico15.html'; // Define o caminho do arquivo HTML
    } elseif (isset($_POST['btn2'])) {
        $message = ""; // URL do vídeo do YouTube
    } elseif (isset($_POST['btn3'])) {
        $message = 'conteudosHistoria/exercicios15.html'; // Exemplo de mensagem simples
    }
}
?>
...
<body>
    ...
    <div class="boxMeio">
        ...
        <br>
        <span class="topico">Primeiro Reinado, Regência e Segundo Reinado.</span>
