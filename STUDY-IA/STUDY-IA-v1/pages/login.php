...
<!--Parte superior-->
    <div class="superior"> 
        ...
        <span class="link"><a href="http://localhost/CGTEC/STUDY-IA/STUDY-IA-v1/pages/login.php" id="link-selecionado">Entrar</a></span>
        <span class="link"><a href="http://localhost/CGTEC/STUDY-IA/STUDY-IA-v1/pages/cadastro.php">Cadastrar</a></span>
