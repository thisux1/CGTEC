...
?>
<?php renderProfileImage($imagemPerfil); ?>
echo "Script atual: " . $_SERVER['SCRIPT_FILENAME'] . "<br>";
echo "Profundidade: " . StudyIAPathResolver::getDepth($_SERVER['SCRIPT_FILENAME']) . "<br>";
<?php
if (isset($imagemPerfil)) {
    echo StudyIAPathResolver::resolveImagePath($imagemPerfil);
} else {
    echo StudyIAPathResolver::resolveImagePath();
}
?>
    ...
    <div id="sidebar" class="sidebar">
       <a href="http://localhost/CGTEC/STUDY-IA/STUDY-IA-v1/pages/materias.php"><h2>Conteúdos</h2></a>
        ...
        <ul>
            ...
            <li><a href="http://localhost/CGTEC/STUDY-IA/STUDY-IA-v1/pages/agenda.php">Agenda</a></li>
            <li><a href="http://localhost/CGTEC/STUDY-IA/STUDY-IA-v1/pages/login.php">Progresso</a></li>
            <li><a href="http://localhost/CGTEC/STUDY-IA/STUDY-IA-v1/pages/home.php">Sair</a></li>
        </ul>
    </div>
