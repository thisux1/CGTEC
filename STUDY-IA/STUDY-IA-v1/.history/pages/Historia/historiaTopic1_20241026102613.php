...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['btn1'])) {
        $message = "http://localhost/CGTEC/STUDY-IA/STUDY-IA-v1/pages/materias.phpTUDY-IA-v1\pages\Historia\conteudoHistoria\topico1.html"; // Define o caminho do arquivo HTML
