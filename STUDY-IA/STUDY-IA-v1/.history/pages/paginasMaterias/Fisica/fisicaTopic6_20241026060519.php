...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['btn1'])) {
        $message = 'conteudosFisica/topico6.html'; // Define o caminho do arquivo HTML
    } elseif (isset($_POST['btn2'])) {
        $message = "https://www.youtube.com/embed/Abfhsry4GFE?si=Ha_D9QeCO0-_Ys1l"; // URL do vídeo do YouTube
    } elseif (isset($_POST['btn3'])) {
        $message = 'conteudosFisica/exercicios6.html'; // Exemplo de mensagem simples
    }
}
?>
...
<body>
    ...
    <div class="boxMeio">
        ...
        <br>
        <span class="topico">Movimento Circular Uniforme (Força Centrípeta)</span>
