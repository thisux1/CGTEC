...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['btn1'])) {
        $message = 'conteudoMatematica/topico7.html'; // Define o caminho do arquivo HTML
    } elseif (isset($_POST['btn2'])) {
        $message = ""; // URL do vídeo do YouTube
    } elseif (isset($_POST['btn3'])) {
        $message = 'conteudoMatematica/exercicios7.html'; // Exemplo de mensagem simples
    }
}
?>
...
<head>
    ...
    <title>STUDY IA | Matematica</title>
</head>
<body>
    ...
    <div class="boxMeio">
        ...
        <span class="titulo">3. Geometria Plana e Trigonometria</span>
        <br>
        <span class="topico">Trigonometria</span>
