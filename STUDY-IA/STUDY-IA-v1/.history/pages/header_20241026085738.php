...
if (isset($imagemPerfil) && !empty($imagemPerfil)) {
  ...
  ho '<img class="imagem1" src="../../images/fotoPerfil.png" alt="perfil">'; // Usando caminho correto para imagem padrão
...
?>
            ...
            <div class="logo-img">
                <a href=
                "http://localhost/CGTEC/STUDY-IA/STUDY-IA-v1/pages/home.php"><img class="logo" src="images/logo2.png" alt="Study IA"></a>
